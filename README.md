...
```bash
gh workflow run prepare-release.yml --repo flonest-app/agentic-ai-skills -f tag=v0.1.17
```
...
The bundled installer defaults to `https://github.com/flonest-app/agentic-ai-skills/releases/latest/download/agentic-ai.tgz`. For a pinned release, pass `--release-tag v0.1.17`.
