...
- Keep generic reusable learning as sanitized public skillhub proposals.
...
- Never emit raw transcripts, secrets, local absolute paths, or private repo names in upstream proposals.
...
- Sanitized upstream feedback packages belong in project `.agentic-ai/outbox/`.
  ...
  "proposals": [
    {
      ...
      "upstream_feedback": "sanitized public feedback text or null"
    }
  ]
}
```
